...
class _ViewPostPageState extends State<ViewPostPage> {
  ...
  Widget build(BuildContext context) {
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    actions: [
                                                                      ElevatedButton(
                                                                        ...
                                                                        child: Text(
                                                                            'Cancel', style: CustomTextStyle.regularText.copyWith(fontSize: responsiveSize(context, 0.04))),
                                                                      ),
                                                                      ElevatedButton(
                                                                        onPressed:
                                                                            () {
                                                                        ...
                                                                        child: Text(
                                                                            'Proceed' , style: CustomTextStyle.regularText.copyWith(fontSize: responsiveSize(context, 0.04))),
                                                                      ),
                                                                    ],
                                                                  ),
                                                                );
    ...
    //   children: [
    //     CustomButton(
    //       onPressed: isApplicationFull ? null : onApplyPressed,
    //       buttonText: isApplicationFull
    //           ? 'Unavailable'
    //           : (isApplied ? 'Applied' : 'Apply Job'),
    //       buttonColor: const Color.fromARGB(255, 243, 107, 4),
    //       textColor: !isApplied && !isApplicationFull
    //           ? Colors.white
    //           : Colors.grey,
    //       width: 155,
    //       height: 53,
